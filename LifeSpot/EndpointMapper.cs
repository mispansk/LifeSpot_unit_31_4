...
namespace LifeSpot
{
    public static class EndpointMapper // отвечает за маппинг путей до статических файлов
    {
        /// <summary>
        ///  Маппинг CSS-файлов
        /// </summary>
        ...
        public static void MapJPG(this IEndpointRouteBuilder builder)
        {
            ...
            foreach (var fileName in jpgFiles)
            {
                ...
                {
                    var jpgPath = Path.Combine(Directory.GetCurrentDirectory(), "Views", "Shared", "slider", fileName);
